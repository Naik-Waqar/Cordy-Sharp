...
namespace Cordy.AST
{
    ...
    {
        public Operator(eNodeKind type, Definition def, BasicNode body, List<string> parameters, List<string> attributes) : base(parameters, attributes)
        {
            Kind = type;
            //pattern defined in def.Args
            //args of opreator is expression with declaration of 2 elements without default value

            // precedence can be set by parameter. By default it's zero
        }
